...
class BreakpointView(ttk.Frame):
    ...
    def __init__(self, controller, app):
        ...
        self.label_profile = ttk.Label(self, text = "Profile", font=("Arial", 9, "bold"))
        ...
        self.label_fixedcost = ttk.Label(self, text = "Fixed Cost", font=("Arial", 9, "bold"))
        self.label_fixedcost.grid(row=1, column=0, padx=10, pady=10)

        self.label_variablecost = ttk.Label(self, text = "Variable Cost", font=("Arial", 9, "bold"))
        self.label_variablecost.grid(row=3, column=0, padx=10, pady=10)

        self.label_number = ttk.Label(self, text = "Number of Unit", font=("Arial", 9, "bold"))
        self.label_number.grid(row=5, column=0, padx=10, pady=10)
        
        self.label_price = ttk.Label(self, text = "Price", font=("Arial", 9, "bold"))
        self.label_price.grid(row=7, column=0, padx=10, pady=10)
        
        self.label_efficieny = ttk.Label(self, text = "Product Efficiency", font=("Arial", 9, "bold"))
        self.label_efficieny.grid(row=9, column=0, padx=10, pady=10)
        
        self.label_amount = ttk.Label(self, text = "Amount of material per product", font=("Arial", 9, "bold"))
        ...
        self.label_fixedcost_unit = ttk.Label(self, text = "Bath", font=("Arial", 9, "bold"))
        self.label_fixedcost_unit.grid(row=1, column=3, padx=10, pady=10)
        
        self.label_variablecost_unit = ttk.Label(self, text = "Bath", font=("Arial", 9, "bold"))
        self.label_variablecost_unit.grid(row=3, column=3, padx=10, pady=10)
        
        self.label_number_unit = ttk.Label(self, text = "Unit", font=("Arial", 9, "bold"))
        self.label_number_unit.grid(row=5, column=3, padx=10, pady=10)
        
        self.label_price_unit = ttk.Label(self, text = "Bath", font=("Arial", 9, "bold"))
        self.label_price_unit.grid(row=7, column=3, padx=10, pady=10)
        
        self.label_efficieny_unit = ttk.Label(self, text = "%", font=("Arial", 9, "bold"))
        self.label_efficieny_unit.grid(row=9, column=3, padx=10, pady=10)
        
        self.label_amount_unit = ttk.Label(self, text = "Unit", font=("Arial", 9, "bold"))
