...
class BreakpointView(ttk.Frame):
    ...
    def __init__(self, controller, app):
        ...
        self.label_profile = ttk.Label(self, text = "ชื่อโปรไฟล์", font=('Tohama', 10), background='white')
        self.label_profile.grid(row=0, column=0, padx=10, pady=10, sticky='W')

        self.label_add = ttk.Label(self, text="", font=('Tohama', 10), background='white')
        self.label_add.grid(row=0, column=1, columnspan=2, padx=10, pady=10, sticky='')
        
        self.label_fixedcost = ttk.Label(self, text = "ต้นทุนคงที่", font=('Tohama', 10), background='white')
        self.label_fixedcost.grid(row=1, column=0, padx=10, pady=10, sticky='W')

        self.label_variablecost = ttk.Label(self, text = "ต้นทุนผันแปร", font=('Tohama', 10), background='white')
        self.label_variablecost.grid(row=3, column=0, padx=10, pady=10, sticky='W')

        self.label_number = ttk.Label(self, text = "ปริมาณการผลิต", font=('Tohama', 10), background='white')
        self.label_number.grid(row=5, column=0, padx=10, pady=10, sticky='W')
        
        self.label_price = ttk.Label(self, text = "ราคาขายต่อหน่วย", font=('Tohama', 10), background='white')
        self.label_price.grid(row=7, column=0, padx=10, pady=10, sticky='W')
        
        self.label_efficieny = ttk.Label(self, text = "กำลังการผลิต", font=('Tohama', 10), background='white')
        ...
        self.label_fixedcost_unit = ttk.Label(self, text = "บาท", font=('Tohama', 10), background='white')
        self.label_fixedcost_unit.grid(row=1, column=3, padx=10, pady=10)
        
        self.label_variablecost_unit = ttk.Label(self, text = "บาท", font=('Tohama', 10), background='white')
        self.label_variablecost_unit.grid(row=3, column=3, padx=10, pady=10)
        
        self.label_number_unit = ttk.Label(self, text = "หน่วย", font=('Tohama', 10), background='white')
